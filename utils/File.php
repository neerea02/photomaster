...

{
    ...
    public function __construct(string $fileInput, array $mimeTypes = [], int $maxSize = 0) {
        ...
        /* Cuidado. Puede ser que si ha habido algun problema en la subida, la variable $_FILES[$filename] y, por tanto $this -> file, no este informada
        */
    ...
    public function saveUploadedFile(string $destPath) {
        ...
        */
        ...
        if (false === move_uploaded_file($this->file["tmp_name"], $ruta)){
            throw new FileException("No se mueve mover el fichero a su destino");
        }
